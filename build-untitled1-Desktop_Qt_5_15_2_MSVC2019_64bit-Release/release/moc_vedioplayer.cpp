...
#include <memory>
#include "../../untitled1/vedioplayer.h"
...
QT_MOC_LITERAL(3, 36, 21), // "on_stopButton_clicked"
QT_MOC_LITERAL(4, 58, 22), // "on_closeButton_clicked"
QT_MOC_LITERAL(5, 81, 27), // "on_SoundVolumn_valueChanged"
QT_MOC_LITERAL(6, 109, 5) // "value"

    },
    "vedioplayer\0on_startButton_clicked\0\0"
    "on_stopButton_clicked\0on_closeButton_clicked\0"
    "on_SoundVolumn_valueChanged\0value"
};
...
void vedioplayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<vedioplayer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_startButton_clicked(); break;
        case 1: _t->on_stopButton_clicked(); break;
        case 2: _t->on_closeButton_clicked(); break;
        case 3: _t->on_SoundVolumn_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject vedioplayer::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_vedioplayer.data,
    qt_meta_data_vedioplayer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
